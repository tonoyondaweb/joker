...
//Pass joke data to TTP API
function telljoke(joke){
    toggleButton();
    VoiceRSS.speech({
        key: 'f561ca19aa294e08b0cc39a22caa8836',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
// disable Button when playing joke
...
async function getJoke(){
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Programming,Dark?blacklistFlags=nsfw,sexist';
    try{
